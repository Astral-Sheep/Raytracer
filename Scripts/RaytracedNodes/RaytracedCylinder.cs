...
[Tool, GlobalClass]
public partial class RaytracedCylinder : CsgCylinder3D, IRaytracedShape<CylinderData>
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining), Pure]
	public IPureShape<CylinderData> AsPureShape(ImmutableDictionary<Material, int> pMaterialTable, Material pDefaultMaterial = null)
	{
		return new PureCylinder {
			radius = Radius,
